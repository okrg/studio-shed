...
<div class="main-content">
	<div class="block-main">
		...
		<img src="<?php echo get_field("top_bg_img");?>" alt="" />
		<div class="info textinfo top-summit">
			<p class="des des-summit"><?php echo get_field( "smt_h2" ); ?></p>
			<h2 class="title-summit"><?php echo get_field( "smt_h1" );?></h2>					
		</div>
	</div>
	...
	<div class="esc block-two shadow block-two-summit">
		<div class="info-content toplayout-title">
			<div class="info title-info">
				<h1 class="titleintro text-uppercase text-title" ><?php echo get_field( "smt_info_title" ); ?></h1>
				<p class="des text-des"><?php echo get_field( "smt_info_des" ); ?></p>
			</div>
		</div>

		<div class="info-content toplayout-address">
			<div class="info">
				<p class="text-uppercase text-specs"><?php echo get_field( "smt_specs" );?></p>
				<?php if( have_rows('info_buttons')) {
				 	while( have_rows('info_buttons') ) {
				 		the_row();
...
<div class="main-content custom-main-content">
	<?php $images = get_field('sldr_image_content'); ?>
...
<div class="main-content">
	<div class="news shadow">
		<div id="newsTabs" class="block-news1">
			<?php $ideas = get_field("flrpln_idea_sct") ?>
			<h3 class="title-flrpln"><?php echo get_field( "flrpln_h" ); ?></h3>
			<ul class="flrpln-btn">
				<?php $count = 1; ?>
	...
	<div class="products-page lv3">
		<section id="content-product" class="container tab-section">
			<div class="tabsection">
				<div id="horizontalTab" class="tab-fltpl">
					<?php $options = get_field("options_tab_content"); ?>
	...
	<div class="block-three">
		<div class="block-flex">
			<div class="column">
				<h3 class="custom-left" id="we_do_title"><?php echo get_field( "blts_title" ); ?><br/><?php echo get_field( "blts_subtitle" ); ?></h3>
			</div>
			<div class="column">
				<?php if( have_rows('blts_content')): ?>
				<ul class="award">
					<?php while( have_rows('blts_content') ): the_row();
	...
	<div class="esc block-two shadow">
		<div class="cover cover-summit">
			<img src="<?php echo get_field( "ftr_image" );  ?>" />
		</div>
		<div class="info-content">
			<div class="info">
				<h3><?php echo get_field( "ftr_title" ); ?></h3>
				<p class="des ftr-des" ><?php echo get_field( "ftr_description" ); ?></p>
				<p class="detail">
					<a href="<?php echo get_field( "ftr_link" ); ?>" class="but"><?php echo get_field("ftr_button_label"); ?></a>
				</p>
			</div>
		</div>
	</div>
