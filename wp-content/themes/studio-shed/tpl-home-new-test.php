<?php
/*
 Template Name: Home page - Fall promo banner
 */
?>
<?php get_header('new');?>
<style>.fall-promodiv {
...
.main-content .block-main .info.textinfo h2.fall-promo-sub {
    color: #fff;
    text-align: center;
    max-width: 900px;
			...
			<div class="block-main banner-home" style="background: url('') no-repeat center center;">
				...
				<div class="info textinfo fall-promodiv">
					<?php if (empty($landing_page_promo_title))
						...
						{
						echo "<h1 class='fall-promo'>" . $landing_page_promo_title . "</h1> <hr /><h2 class='fall-promo-sub'>" .$landing_page_promo_subhead . "</h2> <a href='" . $landing_page_promo_btn_url . "' class='but'>" . $landing_page_promo_btn . "</a><div id='below-top-btn'>" . $landing_page_promo_disclaimer . "</div>";
						} ?> 					
				</div>
