<?php
/*
 Template Name: Home - Wellness Feb 2020 Banner
 */
?>
<?php get_header('new');?>
			...
			<div class="block-main banner-home" style="background: url('') no-repeat center center;">
				...
				<div class="info textinfo holiday-promodiv">
					<?php if (empty($landing_page_promo_title))
						...
						{
						echo "<h2 class='holiday-promo-sub'>" .$landing_page_promo_subhead . "</h2><h1 class='holiday-promo'>" . $landing_page_promo_title . "</h1> <a href='" . $landing_page_promo_btn_url . "' class='but'>" . $landing_page_promo_btn . "</a><div id='below-top-btn'>" . $landing_page_promo_disclaimer . "</div>";
						} ?> 					
				</div>
