...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <style>
		...
		#top-left-line, #top-left-text, #top-right-text-holder, #top-right-text
		{
			position: absolute;
		}
		#top-image
		...
		#top-left-text
		{
			...
			font-size: 26px;
			color: #ffffff;
			padding: 17px 0 24px 34px;
		}
		#top-right-text-holder
		{
			right: 0;
			bottom: 45px;
			width: 567px;
		...
		#content .content-right input[type="text"]
		{
		...
		#content .content-right .gform_footer
		{
			text-align: right;
		}
		#content .content-right input[type="submit"]
		{
		...
		{
			#top-right-text-holder, #top-left-text, #top-right-text
			{
				position: relative;
				max-width: 100%;
				left: auto;
...
<body <?php body_class(); ?>>
  ...
  <header id="header">
      ...
      <nav class="navbar">
       <div class="navbar-header">
          ...
          <div class="mobile-header">
            <a href="/configurator/" class="cta-mobile" style="padding: 2px 12px; background-color: #ffffff; border-color: #ffa347; color: #ffa347 !important; box-shadow: none;">Design Yours Now</a>
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
			<ul id="menu-header-menu" class="nav navbar-nav navbar-right" style="margin-right: 0;">
				<li id="menu-item-1564" class="the-box-item menu-item menu-item-type-post_type menu-item-object-page menu-item-1564 design-yours-now"><a href="http://studioshed.staging.wpengine.com/configurator/">Design Yours Now</a></li>
	...
	?>
		<div class="row">
			<div id="top-image-holder">
				<img id="top-image" src="<?php echo $top_image; ?>" />
				<div id="top-left-text"><?php echo $top_text_left; ?></div>
				<div id="top-left-line"></div>
				<div id="top-right-text-holder">
					<div id="top-right-text"><?php the_title(); ?></div>
				</div>
			</div>
		</div>
	</section>
