  ...
  <head>
    ...
    <title>
        <?php
			...
			/*elseif ($pageUrl = '/products/summit-series/'){
               echo 'Prefab Accessory Dwelling Units (ADU) and Modern Garages | Studio Shed'; } */
            elseif (is_archive()) {
               wp_title('');  }
            elseif (is_search()) {
...
<!-- End Google Tag Manager -->
	...
	<style type="text/css">
	  ...
	  .main-content .block-main .info.selloff{
			top: 0;
			left: 20px;
			transform: translate(0, 0);
		}
		.main-content .block-main .info .promote{
			width: 260px;
		}
		...
		@media only screen and (max-width: 768px) {
			.main-content .block-main .info{
			top: unset;
			bottom: 10px;
			left: 0px;
			transform: unset;
			}
			.main-content .block-main .info h2{
				text-align: center;
				margin-bottom: 10px;
			}
			.main-content .block-main .info p.des{
				text-align: center;
				font-style: italic;
				margin-bottom: 10px;
			}	
	...
	/*form*/
	.main-content .block-three .subscribe-form{
		display: block;
		overflow: hidden;
		width: 100%;
	...
	.main-content .block-three form input[type="text"]{
	...
	.main-content .block-three form input[type="text"]::placeholder{
		color: #f3e6d6;
	}
	.main-content .block-three form input[type="submit"]{
		display: block;
		overflow: hidden;
		width: 220px;
		line-height: 50px;
	...
	.main-content .block-three form input[type="submit"]:hover{
		color: #393939;
		background-color: #fff;
		border: 1px solid #393939;
	}
	.main-content .block-three form ul{
		list-style: none;
	}
	...
	.main-content .block-three form ul .ginput_container_email input{
		width: 100%;
		max-width: 100%;
	}
	.main-content .block-three form .gfield_label, .main-content .block-three form label{
		display: none;
	}
	#gform_wrapper_17 {
		max-width: 100%;
...
<!-- remove below customer request for new home page
  <section id="sologan">
    ...
    <header id="header" class="module" data-module="header">
        ...
        <div class="navbar-collapse" id="main-menu" data-module="menu">
          ...
          <ul class="ml-auto main-menu-ul navbar-nav">
                  ...
                  <div class="row">
                    <ul class="col-lg-5">
                      ...
                      foreach ($models_childs as $key => $childs) {?>
                        <li>
                          <a href="<?php echo $childs["link"]?>" onclick='javascript:return false;'><?php echo $childs["title"]?></a>
                          <div class="nav-item-arrows d-lg-none">
                            <i class="icomoon icon-plus2" aria-hidden="true"></i>
                          </div>
                          <ul class="menu-child menu-list">
                            ...
                            <li>
                              <div class="row">
                                ...
                                <div class="col-lg-7 menu-list-col-lg-7" item-id="item-<?php echo $i?>">
                    ...
                    <ul class="col-lg-7 menu-models-col-lg-7">
                      <?php 
                      $i = 1;
                      foreach ($models_childs as $key => $childs) {?>
                            <?php foreach ($childs["childs"] as $key => $child) {
							  ...
							  $class = "active";
                              ?>
                            <li item="item-<?php echo $i?>" class="item-models <?php //echo $class?> item<?php echo $i?>">
            ...
            <li class="has-sub mega-dropdown menu-shopping">
              <a href="<?php echo $menu_sh_link?>"><span class="icomoon icon-screwdriver"></span><?php echo $menu_sh_title?></a>
              <div class="nav-item-arrows d-lg-none">
                <i class="icomoon icon-plus2" aria-hidden="true"></i>
              </div>
              <div class="dropdown-menu main-menu-dropdown main-menu-dropdown-shopping">
                <div class="container">
                  <div class="row">
                    <ul class="col-lg-4">
                      <li>
                        <!--<a href="<?php //echo "#"//echo $sh_left[0]["link"]?>"  style='background-color:transparent !important;' onclick="return false;"></a>-->
						<span class="heading"><?php echo $sh_left[0]["title"]?></span>
                    ...
                    <ul class="col-lg-4">
                      <li>
                        <!-- <a href="<?php //echo $sh_center[0]["link"]?>"   style='background-color:transparent !important;' onclick="return false;"><?php echo $sh_center[0]["title"]?></a>-->
						<span class="heading"><?php echo $sh_center[0]["title"]?></span>
                        <div class="nav-item-arrows d-lg-none">
                          <i class="icomoon icon-plus2" aria-hidden="true"></i>
                        </div>
                        <ul class="menu-child">
                    ...
                    <ul class="col-lg-4">
                      <li>
                        <!-- <a href="<?php //echo $sh_right[0]["link"]?>"   style='background-color:transparent !important;' onclick="return false;"><?php echo $sh_right[0]["title"]?></a>-->
						<span class="heading"><?php echo $sh_right[0]["title"]?></span>
                        <div class="nav-item-arrows d-lg-none">
                          <i class="icomoon icon-plus2" aria-hidden="true"></i>
                        </div>
                        <ul class="menu-child">
            ...
            ?>
            <li class="has-sub menu-shed">
              <a href="<?php echo $link_r_1?>"><span class="icomoon icon-script"></span><?php echo $title_r_1?></a>
              <div class="nav-item-arrows d-lg-none">
                <i class="icomoon icon-plus2" aria-hidden="true"></i>
              </div>
              <div class="dropdown-menu main-menu-dropdown main-menu-dropdown-shed">
                <ul>
                  <?php
                  foreach ($childs_r_1 as $key => $value) {?>
                  <li>
                    <a href="<?php echo $value["link"]?>" class='item-shed'><?php echo $value["title"]?></a>
            ...
            <li class="has-sub menu-about">
              ...
              <div class="dropdown-menu main-menu-dropdown main-menu-dropdown-about">
                <ul>
                  <?php
