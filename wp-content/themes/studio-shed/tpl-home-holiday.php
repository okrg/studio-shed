<?php
/*
 Template Name: Home page - Holiday promo banner
 */
?>
<?php get_header('new');?>
<style>.holiday-promodiv {
	width: 75%;
}
...
.main-content .block-main .info.textinfo h2.holiday-promo-sub {
    font-family: "Futura-PT-Book";
    text-align: center;
    color: #fff;
    font-size: 1.1em;
...
.main-content .block-main.banner-home {
    ...
    background:  url(<?php echo get_field('mobile_image'); ?>) !important;
...
<?php $page_id = get_the_ID(); ?>
	<div class="main-content">
			<div class="block-main banner-home" style="background: url('') no-repeat center center;">
				...
				$landing_page_promo_title = get_field('landing_page_promo_title');
				$landing_page_promo_subhead = get_field('landing_page_promo_subhead');
				$landing_page_promo_btn = get_field('landing_page_promo_btn');
				$landing_page_promo_btn_url = get_field('landing_page_promo_btn_url');
				$landing_page_promo_disclaimer = get_field('landing_page_promo_disclaimer');
				$mobile_image = get_field('mobile_image');
				
				echo get_the_post_thumbnail();  ?>
				<div class="info textinfo holiday-promodiv">
					<?php if (empty($landing_page_promo_title))
						{
						echo "<h2>" . $image_title . "</h2> <p class='des'>" . $image_description . "</p>";
						}
						else
						{
						echo "<img class='holidaty-ornament' src='https://www.studio-shed.com/wp-content/uploads/2019/11/ornament-offer.png' ><h2 class='holiday-promo-sub'>" .$landing_page_promo_subhead . "</h2><h1 class='holiday-promo'>" . $landing_page_promo_title . "</h1> <a href='" . $landing_page_promo_btn_url . "' class='but'>" . $landing_page_promo_btn . "</a><div id='below-top-btn'>" . $landing_page_promo_disclaimer . "</div>";
						} ?> 					
				</div>
