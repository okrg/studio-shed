...
#content-model-product h3, #create-shed h3 {
    color: #E25D00;
...
.pr-box .headline,.pr-box .sub-headline {
 ...
 #top-info .sub-text,pr-box .sub-headline {
...
.one_half ul, .tab-left ul, .tab-right ul {
	...
	.one_half li, .tab-left li, .tab-right li {
		list-style: none;
	}
	.one-half p strong,
	.tab-left p,
...
-webkit-tap-highlight-color:rgba(0, 0, 0, 0);
Rendered Fonts
Tisa Sans Pro—Network resource(26 glyphs)
</style>
<?php
