...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1711349480352">
  <script src="/assets/main.bundle.js?v=1711349480352"></script>
    ...
    <div class="shadow-lg border border-gray-300 overflow-hidden">
      <div class="relative grid gap-4 bg-gray-100  px-4 py-6 sm:gap-8 sm:p-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <a href="https://www.studio-shed.com/wp-content/uploads/2022/02/Lifestyle-Interiors-Guide-Full-Updated-2.pdf" class="-m-3 p-3 flex items-start hover:opacity-80"
