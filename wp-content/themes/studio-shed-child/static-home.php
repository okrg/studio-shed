...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1687237832928">
  <script src="/assets/main.bundle.js?v=1687237832928"></script>
      ...
      <div class="swiper mx-auto">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl drop-shadow-2xl"><span class="text-white ">Speed</h1>
                <h3 class="text-xl lg:text-4xl font-bold text-white leading-2 drop-shadow-xl"><span class="text-yellow-500">Faster</span> than design-build.</h3>
          ...
          <div class="swiper-slide">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl drop-shadow-2xl">Access</h1>
                <h3 class="text-xl lg:text-4xl font-bold text-white leading-none drop-shadow-xl">Nimble kit of parts.<br><span class="text-yellow-500">No crane needed.</span></h3>
          ...
          <div class="swiper-slide">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl drop-shadow-2xl">Value</h1>
                <h3 class="text-xl lg:text-4xl font-bold text-white leading-none drop-shadow-xl"><span class="text-yellow-500">One-step</span> supply chain.</h3>
                <div class="justify-center flex">
                  <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                    <a href="/models/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Browse Models</a>
                    <a href="https://shop.studio-shed.com/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Design Your Own</a>
          ...
          <div class="swiper-slide">
            <img src="/assets/images/home-slider/summer-15-04.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" style="z-index:-10">
            <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
              <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
            </div>
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl drop-shadow-2xl">Experience</h1>
                <h3 class="text-xl lg:text-4xl font-bold text-white leading-2 drop-shadow-xl"><span class="text-yellow-500">15 years.</span> The only ADU company that ships nationally.</h3>
                <div class="justify-center flex">
                  <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                    <a href="/models/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Browse Models</a>
                    <a href="https://shop.studio-shed.com/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Design Your Own</a>
