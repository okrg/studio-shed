...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1686177817626">
  <script src="/assets/main.bundle.js?v=1686177817626"></script>
...
<main id="page-home">
  ...
  <div class="h-[60vh] bg-black relative">
    ...
    <div class="z-10 pt-12 absolute bottom-0 top-auto inset-0 bg-gradient-to-t from-black to-transparent">

    </div>
  </div>

  <div class="bg-black p-4 md:p-8 pt-0">
  <div class="md:flex justify-between items-center">
    <div>
      <h3 class="text-3xl lg:text-5xl font-extrabold text-white leading-none uppercase"><span class="text-yellow-500">15 Years</span> of <br class="sm:hidden">Studio Shed</h3>
      <div class="md:flex justify-between items-center">
        <h3 class="text-xl lg:text-4xl font-bold text-white leading-none"><span class="text-yellow-500">15% off</span> all models</h3>
        <div class="text-white text-sm md:text-lg py-2">June 1 - June 19</div>
      </div>
    </div>
    <div>
