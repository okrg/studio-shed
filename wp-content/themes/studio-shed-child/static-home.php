...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1682664049178">
  <link rel="shortcut icon" href="/assets/images/favicon.ico">
  <script src="/assets/main.bundle.js?v=1682664049178"></script>
  ...
  <div class="bg-black">
    <div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
      ...
      <div class="mt-6 space-y-4 sm:space-y-0 sm:flex sm:space-x-5">
        <a href="https://shop.studio-shed.com/" class="inline-block mt-6 px-4 py-3 border-2 border-yellow-500 text-base uppercase rounded-full shadow-sm text-white font-medium hover:opacity-80 sm:px-8" title="Studio Shed 3D Design Center">Design &amp; Price</a>
      </div>
    </div>
  </div>
