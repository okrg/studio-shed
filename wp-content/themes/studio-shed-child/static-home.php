...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1720745068688">
  <script src="/assets/main.bundle.js?v=1720745068688"></script>
...
-->
                <div class="swiper-slide">
                  ...
                  <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
                    <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                      <h2 class="text-2xl font-bold tracking-tight text-white sm:text-4xl drop-shadow-2xl">Select Your Savings!</h2>
