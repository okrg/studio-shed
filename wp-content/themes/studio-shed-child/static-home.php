...
<main id="page-home">
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <picture>
            ...
            <img src="/assets/images/home-slider/summer-15-02.jpg" alt="A Studio Shed building assembled in a back yard" class="absolute inset-0 h-full w-full object-cover" style="z-index:-10">
          </picture>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
  ...
  <div x-data="{ activeCard: 1 }" class="py-24 max-w-7xl bg-white mx-auto">
    <h2 class="text-3xl font-bold text-center mb-8">Why Studio Shed?</h2>
    ...
    <div class="overflow-hidden">
        ...
        <div x-show="activeCard === 1" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 transform scale-90" x-transition:enter-end="opacity-100 transform scale-100" class="flex flex-col md:flex-row">
            <div class="md:w-1/2">
                <div class="m-8">
                    <img src="/assets/images/home-why-map.jpg" alt="National Footprint" class="w-auto">
                </div>
            </div>
            <div class="px-4 md:p-8 md:w-1/2">
                <div class="md:m-8">
                    <h3 class="text-2xl font-bold mb-4">Build Your Dream Space with the National Leader in ADUs</h3>
                    <p class="mb-6">At Studio Shed, we combine innovative design with superior craftsmanship to create structures that stand the test of time. As the national leader in accessory dwelling units, our expertise ensures your investment will bring value for years to come.</p>
