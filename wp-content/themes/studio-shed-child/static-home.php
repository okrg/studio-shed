...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1689309168233">
  <script src="/assets/main.bundle.js?v=1689309168233"></script>
...
<a class="w-full text-center py-2 bg-yellow-600 text-white text-xs sm:text-sm font-bold block" href="https://www.studio-shed.com/products/signature-series/#toc-curated" target="_blank">
    ...
    <div class="swiper mx-auto">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <img src="/assets/images/home-process-hero.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" style="z-index:-10">
          ...
          <div class="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
              <h2 class="text-2xl font-bold tracking-tight text-white sm:text-4xl drop-shadow-2xl">Founder's Favorites</h2>
              ...
              <div class="justify-center flex">
                <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                  <a href="/favorites/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">See the Founders Favorite Models</a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="relative -mb-6 w-full overflow-x-auto pb-6">
                    <div class="relative grid grid-cols-2 gap-y-12 md:flex gap-x-24 md:gap-x-8 mx-auto">
                      ...
                      <div class="col-span-2 flex flex-col items-center justify-center">
                        <a href="https://shop.studio-shed.com" class="group w-full md:w-32 border-gray-200 border-2 p-4 my-2">
                          <h3 class="text-xs font-bold uppercase text-center">Build your own</h3>
                        </a>
                        <a href="/products/summit-series/" class="group w-full md:w-32 border-gray-200 border-2 p-4 my-2">
                          <h3 class="text-xs font-bold uppercase text-center">Explore Summit Series</h3>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="relative -mb-6 w-full overflow-x-auto pb-6">
                    <div class="relative grid grid-cols-2 gap-y-12 md:flex gap-x-24 md:gap-x-8 mx-auto">
                      ...
                      <div class="col-span-2 flex flex-col items-center justify-center">
                        ...
                        <a href="https://shop.studio-shed.com" class="group w-full md:w-32 border-gray-200 border-2 p-4 my-2">
                          <h3 class="text-xs font-bold uppercase text-center">Explore Signature Series</h3>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="relative -mb-6 w-full overflow-x-auto pb-6">
                    <div class="relative grid grid-cols-2 gap-y-12 md:flex gap-x-24 md:gap-x-8 mx-auto">
                      ...
                      <div class="col-span-2 flex flex-col items-center justify-center">
                        ...
                        <a href="https://shop.studio-shed.com" class="group w-full md:w-32 border-gray-200 border-2 p-4 my-2">
                          <h3 class="text-xs font-bold uppercase text-center">Explore Portland Series</h3>
                        </a>
                      </div>
                    </div>
                  </div>
