...
<html lang="en-US">
  <head>
    ...
    <meta property="article:modified_time" content="2022-07-29T04:47:26.825Z">
    ...
    <link rel="stylesheet" href="/assets/main.bundle.css?v=1659070046318">
    <link rel="shortcut icon" href="/assets/images/favicon.ico">
    <script src="/assets/main.bundle.js?v=1659070046318"></script>
  ...
  <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
    ...
    <main id="page-home">
<div class="h-[80vh] bg-black relative">
  <div class="swiper mx-auto">  
    <div class="swiper-wrapper">      
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/01.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/02.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/03.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/04.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/05.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/06.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/07.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/08.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
      <div class="swiper-slide">
        <img data-src="/assets/images/home-slider/09.jpg" class="swiper-lazy">
        <div class="swiper-lazy-preloader"></div>
      </div>
    </div>
