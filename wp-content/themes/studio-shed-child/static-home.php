...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1686780866108">
  <script src="/assets/main.bundle.js?v=1686780866108"></script>
          ...
          <div class="swiper-slide">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl drop-shadow-2xl"><span class="text-yellow-500">15 Years</span> of <br class="sm:hidden">Studio Shed</h1>

                  <h3 class="text-xl lg:text-4xl font-bold text-white leading-none drop-shadow-xl"><span class="text-yellow-500">15% off</span> all models</h3>
                  <div class="text-white text-sm md:text-lg py-2 drop-shadow-xl">June 1 - June 19</div>
