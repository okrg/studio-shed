      ...
      <div class="swiper-wrapper">
        ...
        <!--
                <div class="swiper-slide">
                  <img src="/assets/images/aspect/ENV_Gable shads24x24.jpg" alt="" class="inset-0 h-full w-full object-cover" style="z-index:-10;filter:blur(6px)">
                  ...
                  <div class="mx-auto max-w-none">
                    <div class="text-center">
                      <a href="https://design.studio-shed.com" target="_blank">
                        <img class="hidden sm:block" style="width:auto;height: auto;position: relative;transform: translate(-50%,0%);" src="/assets/images/home-slider/spring24-promo.jpeg" />
                        <img class="block sm:hidden" style="width:auto;height: auto;position: relative;transform: translate(-50%,25%);" src="/assets/images/home-slider/spring24-promo.jpeg" />
                      </a>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
                    <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                      <h2 class="text-2xl font-bold tracking-tight text-white sm:text-4xl drop-shadow-2xl">Get the Space you Need Fast!</h2>
                      <h3 class="text-xl lg:text-2xl font-bold text-white leading-2 drop-shadow-xl">25% off all DIY Quick Ship Units!</h3>
                      <div class="justify-center flex">
                        <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                          <a href="https://design.studio-shed.com/signature" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Get Started</a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="swiper-slide">
                ...
                <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
                  <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
                    <h2 class="text-2xl font-bold tracking-tight text-white sm:text-4xl drop-shadow-2xl"></h2>
                    <h3 class="text-xl lg:text-2xl font-bold text-white leading-2 drop-shadow-xl">Take 25% off any DIY Quick Ship Model or choose 0% Financing.<br>10 Days Only!</h3>
                    <div class="justify-center flex">
                      <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                        <a href="https://design.studio-shed.com/signature" target="_blank" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Get Started</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="swiper-slide">
          ...
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
              ...
              <div class="justify-center flex">
                <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                  <a href="/products/aspect/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Learn More</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <img src="/assets/images/home-qs-hero.jpg" alt="" class="absolute inset-0 h-full w-full object-cover object-bottom xl:object-center" style="z-index:-10">
          <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
            <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
          </div>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
              ...
              <div class="justify-center flex">
                <div class="mx-auto flex w-full gap-x-1 sm:w-auto sm:justify-center">
                  <a href="/products/signature-series/" class="transition ease-in-out delay-250 w-full flex mx-0 my-2 sm:mx-2 justify-center p-2 border-2 border-white text-xs md:text-sm text-white uppercase text-center rounded-full hover:opacity-80 sm:w-auto sm:px-4" style="background:rgba(0,0,0,0.5)">Get Started</a>
                </div>
              </div>
            </div>
          </div>
...
-->
        <div class="swiper-slide">
          <picture>
            ...
            <img src="/assets/images/home-slider/summer-15-hero.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" loading="lazy" style="z-index:-10">
          </picture>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
        ...
        <div class="swiper-slide">
          <picture>
            <source srcset="/assets/images/home-slider/summer-15-02.webp" type="image/webp">
            <img src="/assets/images/home-slider/summer-15-02.jpg" alt="A Studio Shed building assembled in a back yard" loading="lazy" class="absolute inset-0 h-full w-full object-cover" style="z-index:-10">
          </picture>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
        ...
        <div class="swiper-slide">
          <picture>
            <source srcset="/assets/images/home-slider/03.webp" type="image/webp">
            <img src="/assets/images/home-slider/03.jpg" alt="" class="absolute inset-0 h-full w-full object-cover" loading="lazy" style="z-index:-10">
          </picture>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
            <div class="text-center py-8" style="background:rgba(0,0,0,0.33)">
    ...
    <div class="grid grid-cols-1 gap-y-12 gap-x-12 md:grid-cols-2 xl:grid-cols-4 lg:gap-x-12">
      <div>
        <a href="/products/aspect/" class="group text-lg text-center"
          ...
          <div class="w-full aspect-w-5 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75 mb-2">
            <picture>
              <source srcset="/assets/images/home-models-aspect.webp" type="image/webp">
              <img loading="lazy" src="/assets/images/home-models-aspect.jpg"
      ...
      <div>
        <a href="/products/summit-series/" class="group text-lg text-center"
          ...
          <div class="w-full aspect-w-5 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75 mb-2">
            <picture>
              <source srcset="/assets/images/home-models-summit.webp" type="image/webp">
      ...
      <div>
        <a href="/products/signature-series/" class="group text-lg text-center"
          ...
          <div class="w-full aspect-w-5 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75 mb-2">
            <picture>
              <source srcset="/assets/images/home-models-signature.webp" type="image/webp">
      ...
      <div>
        <a href="/products/portland-series/" class="group text-lg text-center"
          ...
          <div class="w-full aspect-w-5 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75 mb-2">
            <picture>
              <source srcset="/assets/images/home-models-portland.webp" type="image/webp">
  ...
  <div class="relative">
    ...
    <picture>
      <source srcset="/assets/images/home-invest-exterior.webp" type="image/webp">
    ...
    <div class="relative mt-8 lg:mt-12 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        ...
        <div class="mt-16 flex gap-16 justify-center text-center">
          ...
          <div>
            <picture>
              ...
              <img loading="lazy" src="/assets/images/aspect/aspect-thumb.jpg" alt="Studio Shed Aspect Series" class="w-full h-24 object-contain">
            </picture>
      ...
      <div class="mt-10 mx-0 relative lg:mt-0" aria-hidden="true">
        <div class="w-full h-72 aspect-w-4 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75">
          <picture>
            <source srcset="/assets/images/home-invest-interior.webp" type="image/webp">
    ...
    <div class="relative mt-8 lg:mt-12 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
      ...
      <div class="mt-10 mx-0 relative lg:mt-0" aria-hidden="true">
        <div class="w-full aspect-w-4 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75">
          <picture></picture>
            <source srcset="/assets/images/home-better-way.webp" type="image/webp">
...
<div class="relative">
  <picture></picture>
    <source srcset="/assets/images/home-process-hero.webp" type="image/webp">
...
<div class="max-w-4xl mx-auto text-center py-8 px-4 sm:py-20 sm:px-6 lg:px-8">
  ...
  <div class="relative">
  <picture>
    <source srcset="/assets/images/home-virtual-tour-banner.webp" type="image/webp">
...
<div class="max-w-6xl mx-auto pb-24 px-4 overflow-hidden sm:px-6 lg:px-8">
  <div class="grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-8">
    <div class="w-full aspect-w-4 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75">
      <picture>
        <source srcset="/assets/images/home-tour-kitchen.webp" type="image/webp">
    ...
    <div class="w-full aspect-w-4 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75">
      <picture>
        <source srcset="/assets/images/home-tour-bath.webp" type="image/webp">
    ...
    <div class="w-full aspect-w-4 aspect-h-3 rounded-lg overflow-hidden bg-gray-100 group-hover:opacity-75">
      <picture>
        <source srcset="/assets/images/home-tour-bed.webp" type="image/webp">
  ...
  <div class="text-center">
    <a href="https://tour.studio-shed.com/" target="_blank" class="inline-block mt-6 px-4 py-3 border-2 border-yellow-500 text-base uppercase rounded-full shadow-sm text-black font-medium hover:opacity-80 sm:px-8" title="Studio Shed virtual tour">Take the Tour</a>
  </div>
</div>
...
<div class="bg-black">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 md:flex md:items-center md:justify-between">
    ...
    <div class="mt-6 w-full md:w-1/2">
      <div id="vimeo-container" class="border border-4 border-black rounded" style="padding:56.25% 0 0 0;position:relative;">
        <!-- Placeholder content -->
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        observer.observe(vimeoContainer);
    
        function loadVimeoPlayer() {
          const iframe = document.createElement('iframe');
          iframe.src = "https://player.vimeo.com/video/954126499?badge=0&autopause=0&player_id=0&app_id=58479";
          ...
          iframe.setAttribute('title', 'Studio Shed Timelapse 2024');
    
          vimeoContainer.innerHTML = ''; // Clear placeholder
    ...
    <div class="grid text-center md:grid-cols-3 gap-8 md:text-left lg:grid-cols-6 lg:gap-8">
          ...
          <div class="mt-6">
            ...
            <ul role="list" class="mt-4 space-y-4">
              ...
              <li>
                <a href="/commercial/" class="text-base text-gray-300 hover:text-white" title="Studio Shed commercial projects">
                  Commercial Projects
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/installation-resources/" class="text-base text-gray-300 hover:text-white" title="Studio Shed assembly guides and resources">
                  Assembly Guides
                </a>
              </li>
              <li>
      ...
      <div class="mt-6 col-span-2">
        ...
        <div class="flex space-x-12 mt-24">
          ...
          <a href="https://www.houzz.com/pro/studioshed/" target="_blank" title="Studio Shed design award by Houzz">
            <picture>
              <source srcset="/assets/images/footer-houzz-badge-24.webp" type="image/webp">
              <img loading="lazy" class="self-center w-24 h-auto" src="/assets/images/footer-houzz-badge-24.png" alt="Studio Shed design award by Houzz">
            </picture>
          </a>
