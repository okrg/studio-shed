...
<head>
  ...
  <link rel="stylesheet" href="/assets/main.bundle.css?v=1707260475877">
  <script src="/assets/main.bundle.js?v=1707260475877"></script>
  ...
  <div class="relative isolate h-[50vh] md:h-auto overflow-hidden">
    ...
    <div class="swiper mx-auto">
      <div class="swiper-wrapper">
          ...
          <div class="mx-auto max-w-3xl pt-32">
            <div class="text-center py-8">
              <a href="https://design.studio-shed.com" target="_blank">
                <img style="width:auto;height: auto;position: relative;transform: translate(-50%,-25%);" src="/assets/images/home-slider/nov23-promo.jpg" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <img src="/assets/images/aspect/ENV_Gable shads24x24.jpg" alt="" class="absolute inset-0 h-full w-full object-cover object-bottom xl:object-center" style="z-index:-10">
          <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
            <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
          </div>
          <div class="mx-auto max-w-3xl py-12 sm:py-48 lg:py-48">
