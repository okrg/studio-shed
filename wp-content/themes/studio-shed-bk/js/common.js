jQuery(document).ready(function() {
	...
	jQuery('#modal-video .close').click(pauseVideo);
      ...
      if ( jQuery('#modal-video .modal-backdrop').length )	{
          jQuery('#modal-video .modal-backdrop').live('click', pauseVideo);
      }
  ...
  jQuery('#header.fixed .navbar-toggle.btn-custom').live('click', function(){
 ...
 //}, 2000);
  ...
  checkCookie();
  jQuery('#myModal .close').live('click',function(){
