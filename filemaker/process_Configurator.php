...
$email_search = str_replace("@", "\@", trim(filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL)));
$email = trim(filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL));
$phone = trim(filter_input(INPUT_POST, 'phone', FILTER_SANITIZE_STRING));
//11-28-2018 Ishi: Add new fields to grab from POST
$utm_source = trim(filter_input(INPUT_POST, 'utm_source', FILTER_SANITIZE_STRING));
$utm_medium = trim(filter_input(INPUT_POST, 'utm_medium', FILTER_SANITIZE_STRING));
$utm_campaign = trim(filter_input(INPUT_POST, 'utm_campaign', FILTER_SANITIZE_STRING));
$gclid = trim(filter_input(INPUT_POST, 'gclid', FILTER_SANITIZE_STRING));
$visitor_id = trim(filter_input(INPUT_POST, 'visitor_id', FILTER_SANITIZE_STRING));
