...
file_put_contents('log/log3_'.date("j.n.Y").'.txt', $log, FILE_APPEND);
...
if( $iserror == 0 ) { 	
    ...
    $record->setField('Source', "Contact Us");
    ...
    $record->setField('Subject', "Contact Us Inquiry");
