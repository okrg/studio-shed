...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var Zoom2 = function() {
    ...
    Zoom3.prototype.getModifier = function(rotateValue, axis, el) {
    ...
    Zoom3.prototype.getImageSize = function($image, rotateValue, axis) {
      var imageSizes = {
        y: "offsetHeight",
        x: "offsetWidth"
      };
    ...
    Zoom3.prototype.getDragCords = function(e, rotateValue) {
      if (rotateValue === 90) {
        return {
          x: e.pageY,
          y: e.pageX
    ...
    Zoom3.prototype.getSwipeCords = function(e, rotateValue) {
    ...
    Zoom3.prototype.getDragAllowedAxises = function(rotateValue, scale) {
    ...
    Zoom3.prototype.getCurrentTransform = function(el) {
      if (!el) {
        return;
      }
    ...
    Zoom3.prototype.getCurrentRotation = function(el) {
      if (!el) {
        return 0;
      }
    ...
    Zoom3.prototype.zoomImage = function(scale) {
    ...
    Zoom3.prototype.getPageCords = function(event2) {
      var cords = {};
      if (event2) {
        cords.x = event2.pageX || event2.targetTouches[0].pageX;
        cords.y = event2.pageY || event2.targetTouches[0].pageY;
      } else {
    ...
    Zoom3.prototype.init = function() {
      ...
      this.core.outer.on("touchstart.lg", function(event2) {
        ...
        if (event2.targetTouches.length === 1 && $target.hasClass("lg-image")) {
          if (!tapped) {
    ...
    Zoom3.prototype.zoomIn = function(scale) {
    ...
    Zoom3.prototype.touchendZoom = function(startCoords, endCoords, allowX, allowY, touchDuration, rotateValue) {
    ...
    Zoom3.prototype.isImageSlide = function() {
      var currentItem = this.core.galleryItems[this.core.index];
      return this.core.getSlideType(currentItem) === "image";
    };
    Zoom3.prototype.getPossibleSwipeDragCords = function(rotateValue, scale) {
