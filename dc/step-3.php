    ...
    <section class="dc-installation-resources">
      <div class="row mb-2">
        <div class="col-sm-12 col-lg-8 offset-lg-2">
          <a href="#" class="btn btn-video-trigger"><i class="fas fa-play"></i>Installation Process Overview Video</a>
        </div>
      </div>
      <div class="row mb-2">
        <div class="col-sm-12 col-lg-8 offset-lg-2">
          <a href="#" class="btn btn-video-trigger"><i class="fas fa-file-alt"></i>Installation Guides and Technical Specifications</a>
        </div>
      </div>
    </section>
